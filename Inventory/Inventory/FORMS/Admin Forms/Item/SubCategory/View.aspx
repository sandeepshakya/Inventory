<%@ Page Language="C#" MasterPageFile="~/InventoryChild.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="Inventory.FORMS.Admin_Forms.Item.SubCategory.View" %>
                        ...
                        <div class="box-body">
                            <asp:GridView ID="grdSub" runat="server" OnRowCommand="grdSub_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Category" ShowHeader="true" HeaderStyle-CssClass="sorting_desc">
                                        <ItemTemplate>
                                            <%# Eval("CatName")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="SubCategory" ShowHeader="true" HeaderStyle-CssClass="sorting_desc">
                                        <ItemTemplate>
                                            <%# Eval("Name")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
