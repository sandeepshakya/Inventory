...
public partial class FORMS_Admin_Forms_Item_value_ValueHome : System.Web.UI.Page
{
    ...
    //    anchorAdd.Attributes.Add("href", "~/FORMS/Admin Forms/Item/Value/AddValue.aspx");
    ...
    //    anchorEdit.Attributes.Add("href", "~/FORMS/Admin Forms/Item/Value/EditValue.aspx");

    //    HtmlGenericControl span3 = (HtmlGenericControl)Master.FindControl("Span3");
    //    span3.Attributes.Add("class", "title");
    //    span3.InnerText = "Edit Value";
