<%@ Page Language="C#" MasterPageFile="~/InventoryChild.Master" AutoEventWireup="true" CodeBehind="EditC.aspx.cs" Inherits="Inventory.FORMS.Admin_Forms.Item.Category.EditC" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <asp:GridView ID="grdCat" runat="server"
                                ...
                                AllowPaging="True"
                                CssClass="table table-bordered table-hover dataTable" Width="100%" ShowHeaderWhenEmpty="true">
