...
public partial class Form_Admin_Employee_Management_User_Managemant_EditUser : System.Web.UI.Page
{
    ...
    protected void ActiveSideBarMenu()
    {
        ...
        HtmlGenericControl liEUser = (HtmlGenericControl)Master.FindControl("liEUser");
        liEUser.Attributes.Add("class", "active");
