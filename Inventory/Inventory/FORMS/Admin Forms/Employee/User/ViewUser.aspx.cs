...
public partial class Form_Admin_Employee_Management_User_ViewUser : System.Web.UI.Page
{
    ...
    protected void ActiveSideBarMenu()
    {
        ...
        HtmlGenericControl liVUser = (HtmlGenericControl)Master.FindControl("liVUser");
        liVUser.Attributes.Add("class", "active");
