<%@ Page Language="C#" MasterPageFile="~/InventoryChild.Master" AutoEventWireup="true" CodeBehind="CompMgmt.aspx.cs" Inherits="Inventory.FORMS.System_Admin.cmp" %>
                    ...
                    <tr>
                        ...
                        <td style="" width="18%">
                            <asp:TextBox ID="txtSearch" runat="server" Style="position: relative" Font-Names="Verdana"
                                Font-Size="10pt" Width="150px" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
